...
const UserSignup: React.FC = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_right,rgba(16,185,129,0.2),transparent_28%),linear-gradient(135deg,#0f172a_0%,#2563eb_55%,#dbeafe_100%)] px-4 py-6">
      <div className="mx-auto flex min-h-[calc(100vh-3rem)] w-full max-w-5xl items-center justify-center">
        <div className="grid w-full gap-0 overflow-hidden rounded-[2rem] border border-white/15 bg-white/95 shadow-[0_24px_80px_rgba(15,23,42,0.22)] md:grid-cols-[0.9fr_1.1fr]">
          <aside className="relative overflow-hidden bg-[linear-gradient(180deg,#0f2f1d_0%,#14532d_55%,#1f8a4c_100%)] p-6 text-white md:p-8">
            ...
            <div className="relative mt-10 max-w-md">
              <p className="text-xs font-bold uppercase tracking-[0.45em] text-emerald-100/80">Public Access</p>
              <h1 className="mt-4 text-4xl font-black tracking-tight md:text-5xl">
                Create patient or visitor access
              </h1>
              <p className="mt-4 text-sm leading-6 text-emerald-50/90">
                This account is for queue tracking and public access, not for managing the dashboard.
              </p>
            </div>
          </aside>
          ...
          <main className="p-6 md:p-8">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-slate-500">
                Fill in your details and verify before creating the account.
              </p>
            </div>
